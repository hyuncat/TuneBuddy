...
class MidiSynth:
    """
    Low level synthesizer class, which accepts MIDI messages and
    plays them back using pyfluidsynth and a soundfont.

    Keeps track of 'now' notes to ensure all note playback stops when paused.
    """
