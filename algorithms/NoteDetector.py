...
class NoteDetector:
    def __init__(self, window_size: int=30, pitch_thresh: float=0.6, slope_thresh: float=1):
        self.w = window_size
    ...
    def detect_notes(self, pitches, rank: int=0, w: int=30, pitch_thresh: float=0.6, slope_thresh: float=1):
        """
