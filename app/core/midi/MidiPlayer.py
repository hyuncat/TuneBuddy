...
class MidiPlayer:
    ...
    def load_midi(self, midi: Union[str, MidiData]):
        """
        Load a MIDI file from a file path (str) or a MidiData object and stores data
        ...
        if isinstance(midi, str):
            ...
            raise ValueError("midi_source must be either a file path (str) or a MidiData object")
